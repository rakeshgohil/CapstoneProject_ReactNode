...
// import { FileManagerDownload } from './file-manager-share-dialog';
...
//     const downloadUrl = `http://localhost:5000/download/${file.id}`;
//     window.location.href = downloadUrl; // This triggers the download
//   };
...
export function FileManagerTableRow({ row, selected, onSelectRow, onDeleteRow }) {
  ...
  // Function to close the download dialog
      ...
      >
        <MenuList>
          ...
          <MenuItem
            onClick={() => {
              popover.onClose();
              handleOpenDownloadDialog(row); // Open download dialog with selected file
            }}
          >
            <Iconify icon="solar:download-bold" />
            Download
